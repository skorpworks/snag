...
sub new
{
  ...
  ### Convert old idx format to new, can get rid of this after the next major push
  if(-e $queue_file . '.dat.idx')
  {
    my $old_idx_file = $queue_file . '.dat.idx';
    rename $old_idx_file, $idx_file or die $!;
    print "Renaming $old_idx_file to $idx_file\n";
  }

  $queue_file .= '.dat';

  my $self;
  my $mode = delete $params{mode} || 0660;
